        ...
        class ProductManagementTests {
            ...
            class InterfaceAndPolymorphismTests {
                ...
                void should_demonstratePolymorphism_when_callingProductDetails() {
                    // Arrange
                    Product milk = new FoodProduct(UUID.randomUUID(), "Milk", (jdk.jfr.Category) Category.of("Dairy"), new BigDecimal("15.50"), LocalDate.of(2025, 12, 24), new BigDecimal("1.0"));
                    Product laptop = new ElectronicsProduct(UUID.randomUUID(), "Laptop", (jdk.jfr.Category) Category.of("Electronics"), new BigDecimal("12999"), 24, new BigDecimal("2.2"));
                ...
                void should_findExpiredProducts_when_checkingPerishables() {
                    // Arrange
                    Product freshMilk = new FoodProduct(UUID.randomUUID(), "Fresh Milk", (jdk.jfr.Category) Category.of("Dairy"), new BigDecimal("15"), LocalDate.now().plusDays(5), new BigDecimal("1.0"));
                    Product oldMilk = new FoodProduct(UUID.randomUUID(), "Old Milk", (jdk.jfr.Category) Category.of("Dairy"), new BigDecimal("10"), LocalDate.now().minusDays(2), new BigDecimal("1.0"));
                    Product laptop = new ElectronicsProduct(UUID.randomUUID(), "Laptop", (jdk.jfr.Category) Category.of("Electronics"), new BigDecimal("9999"), 24, new BigDecimal("2.5")); // Not perishable
                ...
                void should_calculateTotalShippingCost_when_summingShippableItems() {
                    ...
                    Product milk = new FoodProduct(UUID.randomUUID(), "Milk", (jdk.jfr.Category) Category.of("Dairy"), new BigDecimal("15"), LocalDate.now().plusDays(5), new BigDecimal("1.2")); // Shipping: 1.2 * 50 = 60
                    Product heavyLaptop = new ElectronicsProduct(UUID.randomUUID(), "Heavy Laptop", (jdk.jfr.Category) Category.of("Electronics"), new BigDecimal("15000"), 24, new BigDecimal("6.0")); // Shipping: 79 + 49 = 128
                    warehouse.addProduct(milk);
        ...
        class FoodProductTests {
            ...
            void should_throwException_when_createdWithNegativePrice() {
                assertThatThrownBy(() -> new FoodProduct(
                        UUID.randomUUID(),
                        "Expired Milk",
                        (jdk.jfr.Category) Category.of("Dairy"),
        ...
        class ElectronicsProductTests {
            ...
            void should_throwException_when_createdWithNegativeWarranty() {
                assertThatThrownBy(() -> new ElectronicsProduct(
                        UUID.randomUUID(),
                        "Time Machine",
                        (jdk.jfr.Category) Category.of("Gadgets"),
